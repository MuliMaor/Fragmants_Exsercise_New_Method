...
public class BlankFragmentTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView emailTextView = view.findViewById(R.id.emailTextbox2);
        TextView passwordTextView = view.findViewById(R.id.passwordTextbox2);
        emailTextView.setText(getArguments().getString("email"));
        passwordTextView.setText(getArguments().getString("password"));

        Button button2to3 = view.findViewById(R.id.button2to3);
        button2to3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_blankFragmentOne_to_blankFragmentTwo);
            }
        });
